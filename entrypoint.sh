...
az cosmosdb sql role assignment create --account-name $ACCOUNT_NAME --resource-groxup $RESOURCE_GROUP_NAME --scope "/" --principal-id $MSI_OBJECT_ID --role-definition-id 00000000-0000-0000-0000-000000000001
